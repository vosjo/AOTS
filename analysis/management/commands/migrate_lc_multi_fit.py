"""Migrate lightcurve_fit analyses to one multi-fit container per light curve."""
...
class Command(BaseCommand):
    help = 'Merge multiple lightcurve_fit analyses per light curve into one multi-fit container.'
