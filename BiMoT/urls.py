...
urlpatterns = [
    ...
    #path(r'api/<slug:project>/stars/', include("stars.api.urls"), name='stars-api'),
    #path(r'api/<slug:project>/spectra/', include("spectra.api.urls"), name='spectra-api'),
    #path(r'api/<slug:project>/analysis/', include("analysis.api.urls"), name='analysis-api'),
