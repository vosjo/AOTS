...
$(document).ready(function() {
   ...
   var edit_note_window = $("#noteEdit").dialog({autoOpen: false, 
         width: 'auto',
         modal: true});
         
   var edit_name_window = $("#nameEdit").dialog({autoOpen: false, 
         width: 'auto',
         modal: true});
...
function openNoteEditBox() {
   edit_note_window = $("#noteEdit").dialog({
      ...
      close: function() { edit_note_window.dialog( "close" ); }
   });
...
function openNameEditBox() {
   edit_name_window = $("#nameEdit").dialog({
      ...
      close: function() { edit_name_window.dialog( "close" ); }
   });
