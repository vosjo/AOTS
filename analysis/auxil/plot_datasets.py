...
def plot_generic_hist(datafile):
    ...
    for i, (name, dataset) in enumerate(data.items()):
        ...
        if 'DISTRIBUTION' in dataset:
            ...
            minv = mpl.Span(location=value - emin, dimension='height', line_color='red', line_width=2,
                            line_dash='dashed')
            maxv = mpl.Span(location=value + emin, dimension='height', line_color='red', line_width=2,
                            line_dash='dashed')
