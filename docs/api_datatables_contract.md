...
|----------|----------------------|----------------|-----------------|
| `/api/systems/stars/` | name, ra, dec, classification, vmag, nphot, analyses, tags, observing_status | nspec, nlc, ra_hms, dec_dms, observing_status_display | `StarListSerializer` |
