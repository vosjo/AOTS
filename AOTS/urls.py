...
urlpatterns = [
                  ...
                  path('w/<slug:project>/', RedirectView.as_view(pattern_name='analysis:dashboard')),
                  ...
                  path('w/<slug:project>/observations/',
                       RedirectView.as_view(pattern_name='observations:observatory_list')),
                  path('w/<slug:project>/analysis/', include('analysis.urls', namespace='analysis')),
                  path('w/<slug:project>/dashboard/', RedirectView.as_view(pattern_name='analysis:dashboard')),
